...
psql -h "$HOST" -p "$PORT" -U postgres -d $DB -v ON_ERROR_STOP=1 -f supabase/tests/03_booking_rpc.sql
echo "OK — schema, order logic, access model and booking gateway verified"
